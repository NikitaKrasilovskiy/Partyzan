...
public class FileBrowserInspector : Editor {
	...
	public static void CreateNew () {
		...
		ComponentSetter.Text(addressTxtTXT, "/", 12*k,
		...
		ComponentSetter.Text(fb.m_Title, "Title", 13*k, 
			new Color(0.2f, 0.2f, 0.2f, 1f),
			TextAnchor.MiddleLeft,
		...
		ComponentSetter.Text(backBtnTxtTXT, "◀", 11*k,//◀◁
			new Color(0.2f, 0.2f, 0.2f, 1f),
		...
		ComponentSetter.Text(forwardBtnTxtTXT, "▶", 11*k,//▶▷
			new Color(0.2f, 0.2f, 0.2f, 1f),
			TextAnchor.MiddleCenter,
			false, true, true, true,
			FontStyle.Normal
		...
		ComponentSetter.Text(quitBtnTxtTXT, "×", 20*k,
		...
		ComponentSetter.Text(nameInputTxtTXT, "", 11*k,
			new Color(0.2f, 0.2f, 0.2f, 1f),
			TextAnchor.MiddleLeft,
			false, true, true, true
		);
		...
		ComponentSetter.Text(fileNameLabelTXT, "File name : ", 11*k, 
			new Color(0, 0, 0, 1), 
		...
		ComponentSetter.Text(fb.m_SubmitBtnText, "O K", 12*k,
			new Color(0.2f, 0.2f, 0.2f, 1f),
			TextAnchor.MiddleCenter,
			false, true, true, true,
			FontStyle.Normal
		...
		ComponentSetter.Text(fb.m_CancelBtnText, "Cancel", 12*k,
			new Color(0.2f, 0.2f, 0.2f, 1f),
			TextAnchor.MiddleCenter,
			false, true, true, true,
			FontStyle.Normal
		...
		ComponentSetter.Text(typeDropDownLabelTXT, "", 12*k,
			new Color(0.2f, 0.2f, 0.2f, 1f),
			TextAnchor.MiddleCenter,
		...
		ComponentSetter.Text(typeDDItemTextTXT, "", 14*k,
			new Color(0.2f, 0.2f, 0.2f, 1f),
			TextAnchor.MiddleCenter,
			false, true, true, true,
			FontStyle.Normal
		...
		ComponentSetter.Text(fileBaseTxtTXT, "", 10*k, 
		...
		ComponentSetter.Text(bookmarkTxtTXT, "", 10*k,
			new Color(0.2f, 0.2f, 0.2f, 1f),
			TextAnchor.MiddleLeft,
			true, true, true, true
		);
		...
		ComponentSetter.Text(bookmarkStarTXT, "●", 11*k,//★☆○●◆
		...
		ComponentSetter.Text(alertOKBtnTxtTXT, "Yes", 11*k,
			new Color(0.2f, 0.2f, 0.2f, 1f),
			TextAnchor.MiddleCenter,
			false, true, true, true,
			FontStyle.Normal
		...
		ComponentSetter.Text(alertCancelBtnTxtTXT, "No", 11*k,
			new Color(0.2f, 0.2f, 0.2f, 1f),
			TextAnchor.MiddleCenter,
			false, true, true, true,
			FontStyle.Normal
